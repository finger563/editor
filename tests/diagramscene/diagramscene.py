    ...
    def mousePressEvent(self, mouseEvent):
        ...
        if self.myMode == self.InsertItem:
            ...
            self.line = QtGui.QGraphicsLineItem(
                QtCore.QLineF(mouseEvent.scenePos(),
                              mouseEvent.scenePos())
            )
...
class MainWindow(QtGui.QMainWindow):
    ...
    def about(self):
        QtGui.QMessageBox.about(
            ...
            "The Diagram Scene example shows use of the graphics framework."
        )
    ...
    def createToolBox(self):
        ...
        layout.addWidget(
            self.createCellWidget("Conditional", DiagramItem.Conditional),
            0, 0
        )
        ...
        textButton.setIcon(
            QtGui.QIcon(QtGui.QPixmap(':/images/textpointer.png')
                        .scaled(30, 30))
        )
        ...
        self.toolBox.setSizePolicy(
            QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Ignored)
        )
