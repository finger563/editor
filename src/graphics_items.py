...
class TextItem(QtGui.QGraphicsTextItem):
    '''
    Acts as a label for a :class:`EditorItem`.  Extends
    :class:`QGraphicsTextItem` with more functionality for setting the
    alignment and position of the text relative to its parent
    :class:`EditorItem`.
