...
class ViewModelItem(QtGui.QGraphicsWidget):

    def __init__(self,
                 parent = None,
                 viewModel = ViewModel()):
        super(ViewModelItem, self).__init__(parent)
    ...
    def paint(self, painter, option, widget = None):
        super(ViewModelItem, self).paint(painter, option, widget)
        if self._item:
    ...
    def addNewItem(self, event):
        self.addChild(ViewModelItem(self, viewModel = ViewModel()))
